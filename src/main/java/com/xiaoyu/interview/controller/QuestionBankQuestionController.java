...
import com.xiaoyu.interview.model.dto.questionbankquestion.*;
import com.xiaoyu.interview.model.entity.QuestionBankQuestion;
import com.xiaoyu.interview.model.entity.User;
import com.xiaoyu.interview.model.vo.QuestionBankQuestionVO;
...
public class QuestionBankQuestionController {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> saveBathQuestionToBank(
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> removeBathQuestionFromBank(
